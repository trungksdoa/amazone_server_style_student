...
//
//	private String rootPath = System.getProperty("user.dir") + "\\BackEnd\\Amazone\\src\\main\\resources\\static\\images\\";
//
//
...
//
//	}
//	public String getFile(MultipartFile file, String subPath) {
//
//		String fileName = generateRandomName() + "." + (file.getContentType().split("/"))[1];
//		String completePath = rootPath + subPath;
//		Path path = Paths.get(completePath);
